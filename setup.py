...
packages = [
    package
    for package in find_packages(where=".", exclude=("test_covid_analytics*",))
...
setup(
    name=package_name,
    description="Covid analytics",
    license="Apache-2.0",
    url="https://github.com/oalam",
    long_description=long_description,
    long_description_content_type="text/x-rst",
    version=package_version,
    author="Thomas Bailet",
    author_email="bailet.thomas@gmail.com",
    project_urls={
        "Documentation": "",
        "Source Code": "https://github.com/oalam",
        "Issue Tracker": "https://github.com/oalam/issues",
    },
    packages=packages,
    package_data={"covid_analytics": ["py.typed", "*.pyi"]},
    ...
    test_suite="test_covid_analytics.run_tests.run_all",
